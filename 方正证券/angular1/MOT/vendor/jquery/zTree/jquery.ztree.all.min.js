    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            cancelPreSelectedNode: function (setting, node, excludeNode) {
                ...
                for (i = list.length - 1; i >= 0; i--) {
                    ...
                    if (node === n || (!node && (!excludeNode || excludeNode !== n))) {
                        $$(n, consts.id.A, setting).parents('.level-con').removeClass(consts.node.CURSELECTED);
                        if (node) {
            ...
            makeDOMNodeLine: function (html, setting, node) {
                html.push("<div class='level-con'><span id='", node.tId, consts.id.SWITCH, "' title='' class='", view.makeNodeLineClass(setting, node), "' treeNode", consts.id.SWITCH, "></span>");
            },
            ...
            selectNode: function (setting, node, addFlag) {
                ...
                $$(node, consts.id.A, setting).parents('.level-con').addClass(consts.node.CURSELECTED);
