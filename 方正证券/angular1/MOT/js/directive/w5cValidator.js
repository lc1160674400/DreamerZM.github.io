        ...
        .provider('w5cValidator', [function () {
            ...
            var validatorFn = function () {
                ...
                this.defaultShowError = function (elem, errorMessages) {
                    ...
                    //     $elem.after('<div class="w5c-error tooltip bottom" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner">'+errorMessages[0]+'</div></div>')
                    //
                    // }
                };
...
(function () {
    ...
    function W5cFormValidateCtrl ($scope, $element, $attrs,
        ...
        this.setValidate = function (formCtrl) {
            ...
            var formPost = formCtrl.formPost = this.formPost.bind(this);
            ...
            formCtrl.w5cValidator = {
                ...
                formPost: this.formPost.bind(this),
        ...
        // 新增 
        this.formPost = function(success,error){
            this.doValidate(function () {
                success();
            }, function ($errors, invalidElements) {
                if(error){
                    error($errors, invalidElements)
                }
        ...
        this.initElement = function (elem) {
            ...
            if (w5cValidator.elemTypes.toString().indexOf(elem.type) > -1 && !w5cValidator.isEmpty(elem.name) && !/^\d/.test(elem.name)) {
                ...
                $scope.$watch($viewValueName, function (nv,ov) {
                    if(nv!=ov){
